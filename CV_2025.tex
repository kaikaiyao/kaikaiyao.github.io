...
\begin{itemize}
    \entry{AI Frameworks Engineer}{Intel Corp.}{Shanghai, China}{2021 -- 2023}
    \begin{itemize}
...
\begin{itemize}
    \item \textbf{Yao K}\textsuperscript{*}, Szil\'{a}gyi B\textsuperscript{*}, Kamp S, Po\'{o}r M, Szilveszter M, Zsoldos MK, Juarez M. \textit{What Breaks Local Watermarks? A Robustness Benchmark for Local Invisible Image Watermarking.} To appear in the 19th ACM Workshop on Artificial Intelligence and Security (AISec), 2026.
    ...
    \item \textbf{Yao K}. \textit{What Does the Credential Still Certify? Cognitive Stewardship for AI-Mediated Education.} To appear in the 9th AAAI/ACM Conference on AI, Ethics, and Society (AIES), 2026.
    \item \textbf{Yao K}. \textit{When AI Does the Work, What Is Learning For? Post-Instrumental Learning and the Risk of Capacity Dissolution.} To appear in the 9th AAAI/ACM Conference on AI, Ethics, and Society (AIES), 2026.
