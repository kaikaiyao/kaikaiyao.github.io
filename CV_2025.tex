...
\begin{itemize}
    \item \textbf{Yao K}, Szil\'{a}gyi B, Kamp S, Po\'{o}r M, Szilveszter M, Zsoldos MK, Juarez M. \textit{What Breaks Local Watermarks? A Robustness Benchmark for Local Invisible Image Watermarking.} To appear in the 19th ACM Workshop on Artificial Intelligence and Security (AISec), 2026.
